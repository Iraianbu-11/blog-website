...
> [!NOTE]
> **HttpOnly**: Prevents client-side JavaScript from accessing the cookie. <br />
> **Secure**: Ensures the cookie is only sent over HTTPS. <br />
> **Max-Age**: Specifies the expiration time in seconds. <br />
